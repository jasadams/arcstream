-- Source: unified events from Redpanda (post-identity-resolution)
CREATE TABLE unified_events (
    ...
    'properties.bootstrap.servers' = 'redpanda.data-pipeline.svc.cluster.local:9092',
...
-- Iceberg catalog on MinIO
CREATE CATALOG iceberg_catalog WITH (
    'type' = 'iceberg',
    'catalog-type' = 'hadoop',
    'warehouse' = 's3a://iceberg-warehouse',
    'io-impl' = 'org.apache.iceberg.aws.s3.S3FileIO',
    's3.endpoint' = 'http://minio.data-pipeline.svc.cluster.local:9000',
...
-- Iceberg writer: unified-events → Parquet on MinIO
